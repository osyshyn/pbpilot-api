...
class UpdateCompanyScheduleRequestSchema(BaseModelSchema):
    """Schema for replacing the full company schedule (working hours)."""

    schedule: Annotated[
        list[CreateCompanyScheduleItemRequestSchema],
        Field(
            description='New working hours list. Days not listed are treated as off.',
            min_length=1,
        ),
    ]
