...
class AwsSettings(BaseSettings):
    ...
    Attributes:
        ...
        INSPECTION_BUCKET_NAME: Private bucket for inspection assets (photos,
            floor plans, samples, documents, signatures). Used for presigned
            direct upload from the mobile app (e.g. pbpilot-inspection-assets).
    ...
    BUCKET_NAME: str
    INSPECTION_BUCKET_NAME: str = 'pbpilot-inspection-assets'
